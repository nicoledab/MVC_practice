...
<center><b>글수정</b>
<br>
<form method="post" name="writeform" action="/mvc/board/updatePro.nhn?pageNum=${pageNum}" onsubmit="return writeSave()">
  ...
  <tr>      
   <td colspan=2 bgcolor="${value_c}" align="center"> 
     ...
     <input type="button" value="목록보기" 
       onclick="document.location.href='list.nhn?pageNum=${pageNum}'">
   </td>
 </tr>
 </table>
</form>
